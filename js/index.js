function defineListaProdutos(produtos){
    let pesquisar =  document.querySelector(".buttonPesquisar")
    ...
    pesquisar.addEventListener("click",function(){
        ...
        novaLista = defineListaProdutosPesquisa(novaLista,preco)
...
function defineListaProdutosPesquisa(produtos,preco){
    ...
    produtos.forEach((produto) =>{
        ...
        produtoNome.forEach((nome) => {
            ...
            if(nome.toLowerCase() == preco.toLowerCase()){
...
function criaDescricaoProduto(produto){
    ...
    buttonAdicionar.classList.add("add-to-cart-button")
...
function resumoCompra(produtos){
    ...
    let resumoCompra = document.createElement("div")
    resumoCompra.classList.add(".resumoCompra")
    let detalheQuantidadeElement = deatalheQuantidade(produtos)
    let detalheTotalElement = detalheTotal(total)
    
    resumoCompra.appendChild(detalheQuantidadeElement)
    resumoCompra.appendChild(detalheTotalElement)
    return resumoCompra
}
...
function carrinho(lista){
    ...
    if(lista.length > 0){
        ...
        let resumoCompraElement =  resumoCompra(lista)
        secao.appendChild(resumoCompraElement)
